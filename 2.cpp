...
public:
	...
	void Run()
	{
		...
		cout << "\n\nCommand : PostComment (post 10, thanks for the wishes)" << endl;
		cout << "--------------------------------------------------------------------------------\n";
		...
		cout << "--------------------------------------------------------------------------------\n";
		if (User::CheckTimeline(curruser) == 0)
		{
			ShareMemory("post10", "Never thought i would be specialist in this field...", curruser);
			curruser->ViewTimeline();
		}
		cout << "--------------------------------------------------------------------------------\n";

		cout << "\n\nCommand : View page" << endl;
		cout << "--------------------------------------------------------------------------------\n";
